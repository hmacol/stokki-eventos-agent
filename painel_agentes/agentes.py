...
AGENTES = [
    ...
    {
        "id": "ler_respostas_insucesso",
        "nome": "Ler Respostas de Insucesso",
        "descricao": "Lê respostas de e-mail sobre insucessos de entrega e decide duplicação automaticamente.",
        "script": "insucesso_entrega/ler_respostas_insucesso.py",
